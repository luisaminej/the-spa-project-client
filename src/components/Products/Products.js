                ...
                <div class="bg-white overflow-hidden">
                    <div class="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="mx-auto text-base max-w-prose lg:grid lg:grid-cols-2 lg:gap-8 lg:max-w-none">
                            <div>
                                <h2 class="text-base text-green-dark font-semibold tracking-wide uppercase">Todos los productos</h2>
                        ...
                        <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
                            ...
                            <div class="relative bg-white">
                                ...
                                <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                                    ...
                                    <h5 class="mt-4 text-1xl leading-8 font-extrabold tracking-tight text-green-transparent sm:text-3xl">Cuerpo</h5>
                                    <br />
                                    ...
                                    <h5 class="mt-4 text-1xl leading-8 font-extrabold tracking-tight text-green-transparent sm:text-3xl">Rostro</h5>
                                    <br />
                                    <div class="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
