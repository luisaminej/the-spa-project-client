                    ...
                    <>
                        <div class="bg-white">
                            <div class="pt-6">
                                    ...
                                    <ol role="list" class="max-w-2xl mx-auto px-4 flex items-center space-x-2 sm:px-6 lg:max-w-7xl lg:px-8">
                                        <li>
                                            <div class="flex items-center">
                                                <a href="/productos" class="mr-2 text-sm font-medium text-green-dark">
                                                    Productos
                                                </a>
                                ...
                                <div class="mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-5xl lg:px-20 lg:grid lg:grid-cols-2 lg:gap-x-1">
                                    ...
                                    <div class="mt-4 lg:mt-0 lg:row-span-3">
                                        ...
                                        <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-1 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
                                            <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
                                                ...
                                                <br></br>
                                                <h7 class="line-through text-2xl text-red-900 sm:text-3xl">

                                                    ${e.pricelist}.00 mxn

                                                </h7>
                                                <p class="text-3xl text-pink-dark">${e.price}<span>.00 MXN</span></p>
                                            </div>
                                            ...
                                            <div class="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="space-y-6">
                                                        <p class="text-base font-extrabold text-green-transparent">{e.description}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mt-10">
                                                    ...
                                                    <div class="mt-4">
                                                        <ul role="list" class="pl-4 list-disc text-sm space-y-2">
                                                            ...
                                                            <li class="text-green-transparent"><span class="text-green-transparent">{e.details4}</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
