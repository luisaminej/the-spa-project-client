            ...
            <div class="bg-white overflow-hidden">
                <div class="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mx-auto text-base max-w-prose lg:grid lg:grid-cols-2 lg:gap-8 lg:max-w-none">
                        <div>
                            <h2 class="text-base text-green-dark font-semibold tracking-wide uppercase">Contacto</h2>
                            ...
                            <div class="relative text-base mx-auto max-w-prose lg:max-w-none">
                                <figure>
                                    <div class="aspect-w-12 aspect-h-7 lg:aspect-none">
                                        <img class="rounded-lg shadow-lg object-cover object-center" src="https://foodandtravel.mx/wp-content/uploads/2021/01/Spas-a-domicilio.jpg" width="1184" height="1276" />
                                    </div>
                            ...
                            <div class="relative max-w-4xl mx-auto lg:grid lg:grid-cols-1">
                                <div class="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
                                    <div class="max-w-lg mx-auto">
                                        <h2 class="text-3xl font-extrabold tracking-tight text-green-transparent sm:text-3xl">
                                            Contáctanos
                                        </h2>
                                        ...
                                        <ul role="list" class="mt-8 flex space-x-12">
                                            <li>
                                                <a class="text-indigo-200 hover:text-indigo-100" href="https://www.facebook.com/">
                                                    ...
                                                    <svg fill="#d18181" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="48px" height="48px">
                                            ...
                                            <li>
                                                <a class="text-indigo-200 hover:text-indigo-100" href="https://www.instagram.com/">
