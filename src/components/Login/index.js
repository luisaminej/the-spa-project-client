                    ...
                    <form className="mt-8 space-y-6" onSubmit={ (e) => { sendData(e) } }>
                        ...
                        <div className="rounded-md shadow-sm -space-y-px">
                            <div>
                                ...
                                autocomplete="email" 
                                required 
                                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-green-dark rounded-t-md focus:outline-none focus:ring-pink-transparent focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Tu correo" 
                        ...
                        <div>
                            <button type="submit" className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-pink-dark hover:bg-pink-transparent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
