...
const FaceState = (props) => {
    ...
    const createFace = async (dataForm) => {
        try {
             ...
             await axios.post("http://localhost:3000/api/face/create", dataForm)
    ...
    const getFace = async () => {
        ...
        try {
            ...
            const respuesta = await axios.get("http://localhost:3000/api/face")
    ...
    const updateFace = async (dataForm) => {  
        ...
        const form = {
         ...
         await axios.post("http://localhost:3005/api/face/update", form)
    ...
    const deleteFace = async (dataForm) => {
        ...
        const res = await axios.post("http://localhost:3005/api/face/delete", form)
