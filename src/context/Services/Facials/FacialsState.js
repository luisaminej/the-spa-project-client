...
const FacialsState = (props) => {
    ...
    const createFacials = async (dataForm) => {
        try {
             ...
             await axios.post(`${process.env.REACT_APP_BASE_URL}/api/services/facials/create`, dataForm)
    ...
    const updateFacials = async (dataForm) => {  
        ...
        const form = {
         ...
         await axios.post(`${process.env.REACT_APP_BASE_URL}/api/services/facials/update`, form)
